...
【可読性ルール】審査員が読むことを意識して必ず段落分けする：
- 1段落 = 1論点、200〜400字を目安に区切る
- 段落と段落の間は空行（連続改行）を入れる
- 「課題①／施策①／効果」のような並列項目は段落を分けるか、行頭に
  ラベル（**【課題①】**等）を付けて視認性を高める
- 長い文章は読点で適度に区切り、1文40〜60字以内
- マークダウン記号（**, #, -）は使わず、日本語の見出し記号（【】、■、①②）
  と段落改行で構造を表現する
